...
<script type="text/javascript">
    $(function(){$("#login-form").submit(function(e){e.preventDefault();var t=$("#login-result");theamus.ajax.api({type:"get",url:"accounts/user-login/",method:["Accounts","login"],data:{form:$("#login-form")},success:function(e){if(typeof e!=="object"){t.html(alert_notify("danger","There was an issue logging in."))}else{if(e.error.status===1){t.html(alert_notify("danger",e.error.message))}else{var n=e.response.data;if(n===true){window.location=$("#redirect_url").val()}else{t.html(alert_notify("danger",n.error.message))}}}}})})})
</script>